...
const required = ['NODE_ENV', 'PORT', 'MONGO_URI', 'REDIS_HOST', 'REDIS_PORT', 'JWT_SECRET', 'QB_CLIENT_ID', 'QB_CLIENT_SECRET', 'QB_REDIRECT_URI', 'QB_WEBHOOK_VERIFIER_TOKEN', 'QB_WEBHOOK_URL'];
...
export const QB_WEBHOOK_VERIFIER_TOKEN = process.env.QB_WEBHOOK_VERIFIER_TOKEN;
...
export const QB_WEBHOOK_URL = process.env.QB_WEBHOOK_URL;

export const FRONTEND_URL = process.env.FRONTEND_URL || 'http://localhost:3000';

logger.log(`Environment: ${ENVIRONMENT} | Port: ${PORT} | QB: ${QB_ENVIRONMENT}`);
logger.log(`QB Webhook URL: ${QB_WEBHOOK_URL}`);
